...
/** Blocks per month estimate for batch 13. */
export const BLOCKS_PER_MONTH_13 = 4320;
...
/** Blocks per month estimate for batch 16. */
export const BLOCKS_PER_MONTH_16 = 4320;
